...
class FeedbacksSenecaClientV1 extends pip_services_seneca_node_1.CommandableSenecaClient {
    constructor(config) {
        super('feedbacks');
        if (config != null)
...
exports.FeedbacksSenecaClientV1 = FeedbacksSenecaClientV1;
//# sourceMappingURL=FeedbacksSenecaClientV1.js.map